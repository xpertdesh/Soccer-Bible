...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#">LA LIGA</a>
...
<?php
echo "<table style='display: inline-block; float: left;'>";
echo "<tr><th> Name</th>
<th>Wins</th>
<th>Loses</th>
<th>Draws</th>
...
try {
    ...
    $stmt = $conn->prepare("SELECT name, wins, loses, draws, PF, PA, diff, points FROM teams WHERE leagueID=2 ORDER BY points DESC");
    $stmt->execute();
...
<?php
echo "<table style='display: inline-block; border: solid 0.5px black; float: right'>";
